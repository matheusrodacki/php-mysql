...
$dadosProduto = $produtoRepositorio->buscarProduto($_GET['id']);
  ...
  <main>
    ...
    <section class="container-form">
      <form method="post" enctype="multipart/form-data">
        ...
        <input type="text" id="descricao" name="descricao" placeholder="Digite uma descrição" value="<?= $dadosProduto->getDescricao(); ?>" required>

        <label for="preco">Preço</label>
        <input type="text" id="preco" name="preco" placeholder="Digite um preço" value="<?= $dadosProduto->getPreco(); ?>" required>
